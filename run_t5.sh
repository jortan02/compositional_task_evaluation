...
# flan-t5-large
python t5_cte.py ./data/multiply_1_digit.csv ./results/multiplication/multiply_1_digit/flan_t5_large_multiply_1_digit.csv google/flan-t5-large
python t5_cte.py ./data/carry.csv ./results/multiplication/carry/flan_t5_large_carry.csv google/flan-t5-large
python t5_cte.py ./data/sum.csv ./results/multiplication/sum/flan_t5_large_sum.csv google/flan-t5-large
python t5_cte.py ./data/multiply.csv ./results/multiplication/multiply/flan_t5_large_multiply.csv google/flan-t5-large
python t5_cte.py ./data/concatenate.csv ./results/multiplication/concatenate/flan_t5_large_concatenate.csv google/flan-t5-large

# flan-t5-xl
python t5_cte.py ./data/multiply_1_digit.csv ./results/multiplication/multiply_1_digit/flan_t5_xl_multiply_1_digit.csv google/flan-t5-xl
python t5_cte.py ./data/carry.csv ./results/multiplication/carry/flan_t5_xl_carry.csv google/flan-t5-xl
python t5_cte.py ./data/sum.csv ./results/multiplication/sum/flan_t5_xl_sum.csv google/flan-t5-xl
python t5_cte.py ./data/multiply.csv ./results/multiplication/multiply/flan_t5_xl_multiply.csv google/flan-t5-xl
python t5_cte.py ./data/concatenate.csv ./results/multiplication/concatenate/flan_t5_xl_concatenate.csv google/flan-t5-xl