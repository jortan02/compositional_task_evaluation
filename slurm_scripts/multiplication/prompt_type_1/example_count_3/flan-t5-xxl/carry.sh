...
# google/flan-t5-xxl
python t5_cte.py ./data/multiplication/prompt_type_1/example_count_3/carry.csv ./results/multiplication/prompt_type_1/example_count_3/carry/flan-t5-xxl/ 10 google/flan-t5-xxl 100