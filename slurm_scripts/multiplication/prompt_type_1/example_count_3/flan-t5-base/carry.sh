...
# google/flan-t5-base
python t5_cte.py ./data/multiplication/prompt_type_1/example_count_1/carry.csv ./results/multiplication/prompt_type_1/example_count_3/carry/flan-t5-base/ 10 google/flan-t5-base 1000