...
# google/flan-t5-xl
python t5_cte.py ./data/multiplication/prompt_type_1/example_count_6/sum.csv ./results/multiplication/prompt_type_1/example_count_6/sum/flan-t5-xl/ 10 google/flan-t5-xl 100
