...
python t5_cte.py ./data/multiplication/prompt_type_1/aggregate_count_1/sum.csv ./results/multiplication/prompt_type_1/aggregate_count_1/sum/flan-t5-small/ 10 google/flan-t5-small 1000
