...
# google/flan-t5-xl
python t5_cte.py ./data/multiplication/prompt_type_1/aggregate_count_1/carry.csv ./results/multiplication/prompt_type_1/aggregate_count_1/carry/flan-t5-xl/ 10 google/flan-t5-xl 1000