...
# google/flan-t5-xl
python t5_cte.py ./data/multiplication/prompt_type_1/aggregate_count_1/concatenate.csv ./results/multiplication/prompt_type_1/aggregate_count_1/concatenate/flan-t5-xl/ 10 google/flan-t5-xl 10