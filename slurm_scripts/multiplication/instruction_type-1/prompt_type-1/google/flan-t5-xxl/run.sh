...
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 1  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 2  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 3  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 4  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 5  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 6  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 7  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 8  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 9  10
sbatch --gres=gpu:2 --mem=10GB --time=4:00:00 ./slurm_scripts/multiplication/instruction_type-1/prompt_type-1/prompts/multiply-primed-7.sh google/flan-t5-xxl 10 10
